...
return ( <section className="relative min-h-screen bg-slate-950 text-white overflow-hidden flex items-center">
  ...
  <div className="relative z-20 max-w-7xl mx-auto px-6 py-24 w-full">
    ...
    <div className="grid md:grid-cols-2 gap-16 items-center">
      ...
      >
        ...
        <h1 className="mt-3 text-4xl sm:text-5xl md:text-7xl font-bold leading-tight">
          Nourin
        ...
        <div className="mt-6 text-xl md:text-2xl font-medium text-cyan-300">
          <TypeAnimation
            sequence={[
        ...
        <p className="mt-6 text-slate-300 max-w-xl leading-8 mx-auto md:mx-0">
          BCA student passionate about Cybersecurity,
          Ethical Hacking, Linux, Networking and Modern
          Web Development. I enjoy building secure
